...
- Make Scorecard publication fail closed: keep OpenSSF-forbidden global/job environment settings out of the publishing path and verify the exact-SHA public API record after the Action completes.
